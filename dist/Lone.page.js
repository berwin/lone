var Lone = typeof Lone === "object" ? Lone : {}; Lone["page"] =
...
/***/ "./packages/lone-compiler-core/codegen/events.js":
/*!*******************************************************!*\
  !*** ./packages/lone-compiler-core/codegen/events.js ***!
  \*******************************************************/
...
function genHandlers(events, isNative, warn) {
  ...
  for (const name in events) {
    const handler = events[name]; // #5330: warn click.right, since right clicks do not actually fire click events.

    if ( true && name === 'click' && handler && handler.modifiers && handler.modifiers.right) {
...
/***/ "./packages/lone-compiler-core/codegen/index.js":
/*!******************************************************!*\
  !*** ./packages/lone-compiler-core/codegen/index.js ***!
  \******************************************************/
/*! exports provided: CodegenState, generate, genElement, genIf, genFor, genData, genChildren, genText, genComment */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _events__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./events */ "./packages/lone-compiler-core/codegen/events.js");
/* harmony import */ var _directives_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../directives/index */ "./packages/lone-compiler-core/directives/index.js");
/* harmony import */ var lone_util__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lone-util */ "./packages/lone-util/index.js");
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../helpers */ "./packages/lone-compiler-core/helpers.js");
/* @flow */
...
class CodegenState {
  constructor(options) {
    ...
    this.warn = options.warn || _helpers__WEBPACK_IMPORTED_MODULE_3__["baseWarn"];
    this.transforms = Object(_helpers__WEBPACK_IMPORTED_MODULE_3__["pluckModuleFunction"])(options.modules, 'transformCode');
    this.dataGenFns = Object(_helpers__WEBPACK_IMPORTED_MODULE_3__["pluckModuleFunction"])(options.modules, 'genData');
    this.directives = Object(lone_util__WEBPACK_IMPORTED_MODULE_2__["extend"])(Object(lone_util__WEBPACK_IMPORTED_MODULE_2__["extend"])({}, _directives_index__WEBPACK_IMPORTED_MODULE_1__["default"]), options.directives);
    const isReservedTag = options.isReservedTag || lone_util__WEBPACK_IMPORTED_MODULE_2__["no"];
...
function genElement(el, state) {
  if (el.staticRoot && !el.staticProcessed) {
    ...
    if (el.component) {
      ...
      // 如果el.plain是true，说明该结点没有 attr, attrsList.length === 0
...
function genData(el, state) {
  ...
  if (el.events) {
    data += `${Object(_events__WEBPACK_IMPORTED_MODULE_0__["genHandlers"])(el.events, false, state.warn)},`;
  }

  if (el.nativeEvents) {
    data += `${Object(_events__WEBPACK_IMPORTED_MODULE_0__["genHandlers"])(el.nativeEvents, true, state.warn)},`;
  } // slot target
...
function genSlot(el, state) {
  ...
  const attrs = el.attrs && `{${el.attrs.map(a => `${Object(lone_util__WEBPACK_IMPORTED_MODULE_2__["camelize"])(a.name)}:${a.value}`).join(',')}}`;
...
/*!********************************************************!*\
  !*** ./packages/lone-compiler-core/create-compiler.js ***!
  \********************************************************/
/*! exports provided: createCompilerCreator */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _error_detector__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./error-detector */ "./packages/lone-compiler-core/error-detector.js");
/* harmony import */ var _to_function__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./to-function */ "./packages/lone-compiler-core/to-function.js");
/* @flow */
...
function createCompilerCreator(baseCompile) {
  return function createCompiler(baseOptions) {
    function compile(template, options) {
      ...
      if (options) {
        ...
        if (options.directives) {
          finalOptions.directives = Object(lone_util__WEBPACK_IMPORTED_MODULE_0__["extend"])(Object.create(baseOptions.directives), options.directives);
        } // copy other options
      ...
      if (true) {
        errors.push.apply(errors, Object(_error_detector__WEBPACK_IMPORTED_MODULE_1__["detectErrors"])(compiled.ast));
      }
    ...
    return {
      compile,
      compileToFunctions: Object(_to_function__WEBPACK_IMPORTED_MODULE_2__["createCompileToFunctionFn"])(compile)
    };
  };
}
...
/***/ "./packages/lone-compiler-core/directives/bind.js":
/*!********************************************************!*\
  !*** ./packages/lone-compiler-core/directives/bind.js ***!
  \********************************************************/
...
/***/ "./packages/lone-compiler-core/directives/index.js":
/*!*********************************************************!*\
  !*** ./packages/lone-compiler-core/directives/index.js ***!
  \*********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _on__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./on */ "./packages/lone-compiler-core/directives/on.js");
/* harmony import */ var _bind__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./bind */ "./packages/lone-compiler-core/directives/bind.js");
/* harmony import */ var lone_util__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lone-util */ "./packages/lone-util/index.js");
/* @flow */
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  cloak: lone_util__WEBPACK_IMPORTED_MODULE_2__["noop"]
});

/***/ }),

/***/ "./packages/lone-compiler-core/directives/model.js":
/*!*********************************************************!*\
  !*** ./packages/lone-compiler-core/directives/model.js ***!
  \*********************************************************/
/*! exports provided: genComponentModel, genAssignmentCode, parseModel */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./packages/lone-compiler-core/directives/on.js":
/*!******************************************************!*\
  !*** ./packages/lone-compiler-core/directives/on.js ***!
  \******************************************************/
/*! exports provided: default */
...
function on(el, dir) {
  if ( true && dir.modifiers) {
    Object(lone_util__WEBPACK_IMPORTED_MODULE_0__["warn"])('v-on without argument does not support modifiers.');
  }
...
/***/ "./packages/lone-compiler-core/error-detector.js":
/*!*******************************************************!*\
  !*** ./packages/lone-compiler-core/error-detector.js ***!
  \*******************************************************/
...
/* harmony import */ var _parser_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./parser/index */ "./packages/lone-compiler-core/parser/index.js");
/* @flow */
...
const unaryOperatorsRE = new RegExp('\\b' + 'delete,typeof,void'.split(',').join('\\s*\\([^\\)]*\\)|\\b') + '\\s*\\([^\\)]*\\)'); // check valid identifier for v-for

const identRE = /[A-Za-z_$][\w$]*/; // strip strings in expressions
...
/***/ "./packages/lone-compiler-core/helpers.js":
/*!************************************************!*\
  !*** ./packages/lone-compiler-core/helpers.js ***!
  \************************************************/
...
/* harmony import */ var _parser_filter_parser__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./parser/filter-parser */ "./packages/lone-compiler-core/parser/filter-parser.js");
/* @flow */
...
function addHandler(el, name, value, modifiers, important, warn) {
  ...
  /* istanbul ignore if */
  if ( true && warn && modifiers && modifiers.prevent && modifiers.passive) {
...
function getBindingAttr(el, name, getStatic) {
  ...
  if (dynamicValue != null) {
    return Object(_parser_filter_parser__WEBPACK_IMPORTED_MODULE_0__["parseFilters"])(dynamicValue);
...
/***/ "./packages/lone-compiler-core/index.js":
/*!**********************************************!*\
  !*** ./packages/lone-compiler-core/index.js ***!
  \**********************************************/
/*! exports provided: createCompiler */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _parser_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./parser/index */ "./packages/lone-compiler-core/parser/index.js");
/* harmony import */ var _codegen_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./codegen/index */ "./packages/lone-compiler-core/codegen/index.js");
/* harmony import */ var _create_compiler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./create-compiler */ "./packages/lone-compiler-core/create-compiler.js");
...
const createCompiler = Object(_create_compiler__WEBPACK_IMPORTED_MODULE_2__["createCompilerCreator"])(function baseCompile(template, options) {
  const ast = Object(_parser_index__WEBPACK_IMPORTED_MODULE_0__["parse"])(template.trim(), options);
  const code = Object(_codegen_index__WEBPACK_IMPORTED_MODULE_1__["generate"])(ast, options);
  return {
    ast,
    render: code.render,
...
/***/ "./packages/lone-compiler-core/node_modules/he/he.js":
/*!***********************************************************!*\
  !*** ./packages/lone-compiler-core/node_modules/he/he.js ***!
  \***********************************************************/
/*! no static exports found */
...
/***/ "./packages/lone-compiler-core/parser/filter-parser.js":
/*!*************************************************************!*\
  !*** ./packages/lone-compiler-core/parser/filter-parser.js ***!
  \*************************************************************/
...
function parseFilters(exp) {
  ...
  let c, prev, i, expression, filters; // 循环将filter push到 filters 中
  // Example： a|b 则 filters = [a,b]
...
/***/ "./packages/lone-compiler-core/parser/html-parser.js":
/*!***********************************************************!*\
  !*** ./packages/lone-compiler-core/parser/html-parser.js ***!
  \***********************************************************/
/*! exports provided: isPlainTextElement, parseHTML */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const isPlainTextElement = Object(lone_util__WEBPACK_IMPORTED_MODULE_0__["makeMap"])('script,style,textarea', true);
const reCache = {};
const decodingMap = {
  '&lt;': '<',
  '&gt;': '>',
...
const encodedAttrWithNewLines = /&(?:lt|gt|quot|amp|#10);/g; // #5992

const isIgnoreNewlineTag = Object(lone_util__WEBPACK_IMPORTED_MODULE_0__["makeMap"])('pre,textarea', true);
...
function parseHTML(html, options) {
  ...
  const isUnaryTag = options.isUnaryTag || lone_util__WEBPACK_IMPORTED_MODULE_0__["no"];
  const canBeLeftOpenTag = options.canBeLeftOpenTag || lone_util__WEBPACK_IMPORTED_MODULE_0__["no"];
  let index = 0;
  let last, lastTag;
  ...
  while (html) {
    ...
    if (!lastTag || !isPlainTextElement(lastTag)) {
      ...
      // 需要处理一个特俗情况如果 < 是文本的情况，aaa<:fdfd<div 这种情况需要从 a 截取到第二个<，截取之后只剩下 <div
      ...
      // lastTag 为 script，style，textarea的情况
      let endTagLength = 0;
  ...
  function handleStartTag(match) {
    ...
    if (expectHTML) {
      if (lastTag === 'p' && Object(lone_util__WEBPACK_IMPORTED_MODULE_0__["isNonPhrasingTag"])(tagName)) {
        parseEndTag(lastTag);
      }
    ...
    } // 如果当前标签的开始是没有 “/” 的，那表示当前标签有子集
    // 当进入子标签时将当前标签数据推入到 stack 中
    // lastTag 是 parentDOM
...
/*!*****************************************************!*\
  !*** ./packages/lone-compiler-core/parser/index.js ***!
  \*****************************************************/
/*! exports provided: onRE, dirRE, forAliasRE, forIteratorRE, warn, createASTElement, parse, processElement, processFor, addIfCondition */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var he__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! he */ "./packages/lone-compiler-core/node_modules/he/he.js");
...
/* harmony import */ var _html_parser__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./html-parser */ "./packages/lone-compiler-core/parser/html-parser.js");
/* harmony import */ var _text_parser__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./text-parser */ "./packages/lone-compiler-core/parser/text-parser.js");
/* harmony import */ var _filter_parser__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./filter-parser */ "./packages/lone-compiler-core/parser/filter-parser.js");
/* harmony import */ var lone_util__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! lone-util */ "./packages/lone-util/index.js");
/* harmony import */ var _directives_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../directives/model */ "./packages/lone-compiler-core/directives/model.js");
/* harmony import */ var lone_util_env__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! lone-util/env */ "./packages/lone-util/env.js");
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../helpers */ "./packages/lone-compiler-core/helpers.js");
/* @flow */
...
const bindRE = /^:|^v-bind:/;
const modifierRE = /\.[^.]+/g;
const decodeHTMLCached = Object(lone_util__WEBPACK_IMPORTED_MODULE_4__["cached"])(he__WEBPACK_IMPORTED_MODULE_0___default.a.decode); // configurable state
...
function parse(template, options) {
  ...
  platformIsPreTag = options.isPreTag || lone_util__WEBPACK_IMPORTED_MODULE_4__["no"];
  platformMustUseProp = options.mustUseProp || lone_util__WEBPACK_IMPORTED_MODULE_4__["no"];
  platformGetTagNamespace = options.getTagNamespace || lone_util__WEBPACK_IMPORTED_MODULE_4__["no"];
  ...
  Object(_html_parser__WEBPACK_IMPORTED_MODULE_1__["parseHTML"])(template, {
    ...
    start(tag, attrs, unary) {
      ...
      if (lone_util_env__WEBPACK_IMPORTED_MODULE_6__["isIE"] && ns === 'svg') {
      ...
      if (ns) {
        element.ns = ns;
      } // isForbiddenTag：判断element是不是 style 或者 script 标签
      ...
      if (!root) {
        // 首次解析到标签开始
        root = element; // 将第一个解析到的标签设置为root

        checkRootConstraints(root);
      } else if (!stack.length) {
        // 能进到这里面，说明root元素不唯一，也就是有两个或多个root元素
      ...
      } // 如果当前 标签不是 style 和 script
      // 将当前标签 push 到 父标签的 children 中
      // 将当前标签的 parent 设置为父标签（stack 中的最后一个）
    ...
    chars(text) {
      ...
      if (lone_util_env__WEBPACK_IMPORTED_MODULE_6__["isIE"] && currentParent.tag === 'textarea' && currentParent.attrsMap.placeholder === text) {
        return;
      }
      ...
      // children.length 可以判断出当前是否解析到开始标签后面，开始标签后面children肯定是0，因为还没解析到children呢
      // 所以只有开始标签后面的没有空格例如<p>  <span>，这中间的空格就没有了
...
function processFor(el) {
  ...
  if (exp = Object(_helpers__WEBPACK_IMPORTED_MODULE_7__["getAndRemoveAttr"])(el, 'v-for')) {
    ...
    if (!inMatch) {
       true && warn(`Invalid v-for expression: ${exp}`);
      return;
    }
    ...
    if (dirRE.test(name)) {
      ...
      if (bindRE.test(name)) {
        ...
        if (modifiers) {
          if (modifiers.prop) {
            isProp = true;
            name = Object(lone_util__WEBPACK_IMPORTED_MODULE_4__["camelize"])(name);
          ...
          if (modifiers.sync) {
            Object(_helpers__WEBPACK_IMPORTED_MODULE_7__["addHandler"])(el, `update:${Object(lone_util__WEBPACK_IMPORTED_MODULE_4__["camelize"])(name)}`, Object(_directives_model__WEBPACK_IMPORTED_MODULE_5__["genAssignmentCode"])(value, '$event'));
          }
        }
      ...
      // literal attribute
      if (true) {
        const expression = Object(_text_parser__WEBPACK_IMPORTED_MODULE_2__["parseText"])(value, delimiters);
...
function makeAttrsMap(attrs) {
  ...
  for (let i = 0, l = attrs.length; i < l; i++) {
    if ( true && map[attrs[i].name] && !lone_util_env__WEBPACK_IMPORTED_MODULE_6__["isIE"] && !lone_util_env__WEBPACK_IMPORTED_MODULE_6__["isEdge"]) {
...
/* harmony import */ var lone_util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lone-util */ "./packages/lone-util/index.js");
/* harmony import */ var _filter_parser__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./filter-parser */ "./packages/lone-compiler-core/parser/filter-parser.js");
/* @flow */


const defaultTagRE = /\{\{((?:.|\n)+?)\}\}/g; // eslint-disable-next-line no-useless-escape

const regexEscapeRE = /[-.*+?^${}()|[\]\/\\]/g;
const buildRegex = Object(lone_util__WEBPACK_IMPORTED_MODULE_0__["cached"])(delimiters => {
...
function parseText(text, delimiters) {
  ...
  while (match = tagRE.exec(text)) {
    index = match.index; // 先把 {{ 双大括号前边的 text push 到 tokens 中
    // push text token
...
/*!****************************************************!*\
  !*** ./packages/lone-compiler-core/to-function.js ***!
  \****************************************************/
/*! exports provided: createCompileToFunctionFn */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function createFunction(code, errors) {
  try {
    ...
    return lone_util__WEBPACK_IMPORTED_MODULE_0__["noop"];
  }
}
...
function createCompileToFunctionFn(compile) {
  ...
  return function compileToFunctions(template, options, vm) {
    options = Object(lone_util__WEBPACK_IMPORTED_MODULE_0__["extend"])({}, options);
    const warn = options.warn || lone_util__WEBPACK_IMPORTED_MODULE_0__["warn"];
    delete options.warn; // check cache
    ...
    if (true) {
      ...
      if (compiled.tips && compiled.tips.length) {
        compiled.tips.forEach(msg => Object(lone_util__WEBPACK_IMPORTED_MODULE_0__["tip"])(msg, vm));
      }
...
function html(el, dir) {
  if (dir.value) {
    Object(lone_compiler_core_helpers__WEBPACK_IMPORTED_MODULE_0__["addProp"])(el, 'innerHTML', `_s(${dir.value})`);
  }
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./model */ "./packages/lone-compiler-dom/directives/model.js");
/* harmony import */ var _text__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./text */ "./packages/lone-compiler-dom/directives/text.js");
/* harmony import */ var _html__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./html */ "./packages/lone-compiler-dom/directives/html.js");
...
/*!********************************************************!*\
  !*** ./packages/lone-compiler-dom/directives/model.js ***!
  \********************************************************/
/*! exports provided: RANGE_TOKEN, CHECKBOX_RADIO_TOKEN, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var lone_util_web_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lone-util/web/element */ "./packages/lone-util/web/element.js");
...
/* harmony import */ var lone_compiler_core_directives_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lone-compiler-core/directives/model */ "./packages/lone-compiler-core/directives/model.js");
/* @flow */



let warn; // in some cases, the event used has to be determined at runtime
...
function model(el, dir, _warn) {
  ...
  if (el.component) {
    Object(lone_compiler_core_directives_model__WEBPACK_IMPORTED_MODULE_2__["genComponentModel"])(el, value, modifiers); // component v-model doesn't need extra runtime
  ...
  } else if (!Object(lone_util_web_element__WEBPACK_IMPORTED_MODULE_0__["isReservedTag"])(tag)) {
    Object(lone_compiler_core_directives_model__WEBPACK_IMPORTED_MODULE_2__["genComponentModel"])(el, value, modifiers); // component v-model doesn't need extra runtime
...
function genCheckboxModel(el, value, modifiers) {
  ...
  const valueBinding = Object(lone_compiler_core_helpers__WEBPACK_IMPORTED_MODULE_1__["getBindingAttr"])(el, 'value') || 'null';
  const trueValueBinding = Object(lone_compiler_core_helpers__WEBPACK_IMPORTED_MODULE_1__["getBindingAttr"])(el, 'true-value') || 'true';
  const falseValueBinding = Object(lone_compiler_core_helpers__WEBPACK_IMPORTED_MODULE_1__["getBindingAttr"])(el, 'false-value') || 'false';
  Object(lone_compiler_core_helpers__WEBPACK_IMPORTED_MODULE_1__["addProp"])(el, 'checked', `Array.isArray(${value})` + `?_i(${value},${valueBinding})>-1` + (trueValueBinding === 'true' ? `:(${value})` : `:_q(${value},${trueValueBinding})`));
  Object(lone_compiler_core_helpers__WEBPACK_IMPORTED_MODULE_1__["addHandler"])(el, 'change', `var $$a=${value},` + '$$el=$event.target,' + `$$c=$$el.checked?(${trueValueBinding}):(${falseValueBinding});` + 'if(Array.isArray($$a)){' + `var $$v=${number ? '_n(' + valueBinding + ')' : valueBinding},` + '$$i=_i($$a,$$v);' + `if($$el.checked){$$i<0&&(slave.send('page:data', 'logic', {id: id, data:{${value}: $$a.concat([$$v])}}))}` + `else{$$i>-1&&(slave.send('page:data', 'logic', {id: id, data:{${value}: $$a.slice(0,$$i).concat($$a.slice($$i+1))}}))}` + `}else{${Object(lone_compiler_core_directives_model__WEBPACK_IMPORTED_MODULE_2__["genAssignmentCode"])(value, '$$c')}}`, null, true);
}

function genRadioModel(el, value, modifiers) {
  const number = modifiers && modifiers.number;
  let valueBinding = Object(lone_compiler_core_helpers__WEBPACK_IMPORTED_MODULE_1__["getBindingAttr"])(el, 'value') || 'null';
  valueBinding = number ? `_n(${valueBinding})` : valueBinding;
  Object(lone_compiler_core_helpers__WEBPACK_IMPORTED_MODULE_1__["addProp"])(el, 'checked', `_q(${value},${valueBinding})`);
  const name = Object(lone_compiler_core_helpers__WEBPACK_IMPORTED_MODULE_1__["getBindingAttr"])(el, 'name');
  if (!name) Object(lone_compiler_core_helpers__WEBPACK_IMPORTED_MODULE_1__["addAttr"])(el, 'name', `"${value}"`);
  Object(lone_compiler_core_helpers__WEBPACK_IMPORTED_MODULE_1__["addHandler"])(el, 'change', Object(lone_compiler_core_directives_model__WEBPACK_IMPORTED_MODULE_2__["genAssignmentCode"])(value, valueBinding), null, true);
}
...
function genSelect(el, value, modifiers) {
  ...
  code = `${code} ${Object(lone_compiler_core_directives_model__WEBPACK_IMPORTED_MODULE_2__["genAssignmentCode"])(value, assignment)}`;
  Object(lone_compiler_core_helpers__WEBPACK_IMPORTED_MODULE_1__["addHandler"])(el, 'change', code, null, true);
}
...
function genDefaultModel(el, value, modifiers) {
  ...
  let code = Object(lone_compiler_core_directives_model__WEBPACK_IMPORTED_MODULE_2__["genAssignmentCode"])(value, valueExpression);

  if (needCompositionGuard) {
    code = `if($event.target.composing)return;${code}`;
  }

  Object(lone_compiler_core_helpers__WEBPACK_IMPORTED_MODULE_1__["addProp"])(el, 'value', `(${value})`);
  Object(lone_compiler_core_helpers__WEBPACK_IMPORTED_MODULE_1__["addHandler"])(el, event, code, null, true);

  if (trim || number) {
    Object(lone_compiler_core_helpers__WEBPACK_IMPORTED_MODULE_1__["addHandler"])(el, 'blur', '$forceUpdate()');
  }
}
...
function text(el, dir) {
  if (dir.value) {
    Object(lone_compiler_core_helpers__WEBPACK_IMPORTED_MODULE_0__["addProp"])(el, 'textContent', `_s(${dir.value})`);
  }
}
...
/*!*********************************************!*\
  !*** ./packages/lone-compiler-dom/index.js ***!
  \*********************************************/
/*! exports provided: compile, compileToFunctions */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _options__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./options */ "./packages/lone-compiler-dom/options.js");
/* harmony import */ var lone_compiler_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lone-compiler-core */ "./packages/lone-compiler-core/index.js");


const {
  compile,
  compileToFunctions
} = Object(lone_compiler_core__WEBPACK_IMPORTED_MODULE_1__["createCompiler"])(_options__WEBPACK_IMPORTED_MODULE_0__["baseOptions"]);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _class__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./class */ "./packages/lone-compiler-dom/modules/class.js");
/* harmony import */ var _style__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style */ "./packages/lone-compiler-dom/modules/style.js");
/* harmony import */ var _model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./model */ "./packages/lone-compiler-dom/modules/model.js");
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var lone_compiler_core_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lone-compiler-core/helpers */ "./packages/lone-compiler-core/helpers.js");
/* harmony import */ var lone_compiler_core_parser_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lone-compiler-core/parser/index */ "./packages/lone-compiler-core/parser/index.js");
/* @flow */
...
function preTransformNode(el, options) {
  if (el.tag === 'input') {
    ...
    if (map['v-model'] && (map['v-bind:type'] || map[':type'])) {
      const typeBinding = Object(lone_compiler_core_helpers__WEBPACK_IMPORTED_MODULE_0__["getBindingAttr"])(el, 'type');
      const ifCondition = Object(lone_compiler_core_helpers__WEBPACK_IMPORTED_MODULE_0__["getAndRemoveAttr"])(el, 'v-if', true);
      const ifConditionExtra = ifCondition ? `&&(${ifCondition})` : ''; // 1. checkbox

      const branch0 = cloneASTElement(el); // process for on the main node

      Object(lone_compiler_core_parser_index__WEBPACK_IMPORTED_MODULE_1__["processFor"])(branch0);
      addRawAttr(branch0, 'type', 'checkbox');
      Object(lone_compiler_core_parser_index__WEBPACK_IMPORTED_MODULE_1__["processElement"])(branch0, options);
      branch0.processed = true; // prevent it from double-processed

      branch0.if = `(${typeBinding})==='checkbox'` + ifConditionExtra;
      Object(lone_compiler_core_parser_index__WEBPACK_IMPORTED_MODULE_1__["addIfCondition"])(branch0, {
        exp: branch0.if,
        block: branch0
      }); // 2. add radio else-if condition

      const branch1 = cloneASTElement(el);
      Object(lone_compiler_core_helpers__WEBPACK_IMPORTED_MODULE_0__["getAndRemoveAttr"])(branch1, 'v-for', true);
      addRawAttr(branch1, 'type', 'radio');
      Object(lone_compiler_core_parser_index__WEBPACK_IMPORTED_MODULE_1__["processElement"])(branch1, options);
      Object(lone_compiler_core_parser_index__WEBPACK_IMPORTED_MODULE_1__["addIfCondition"])(branch0, {
      ...
      Object(lone_compiler_core_helpers__WEBPACK_IMPORTED_MODULE_0__["getAndRemoveAttr"])(branch2, 'v-for', true);
      addRawAttr(branch2, ':type', typeBinding);
      Object(lone_compiler_core_parser_index__WEBPACK_IMPORTED_MODULE_1__["processElement"])(branch2, options);
      Object(lone_compiler_core_parser_index__WEBPACK_IMPORTED_MODULE_1__["addIfCondition"])(branch0, {
        exp: ifCondition,
        block: branch2
      });
...
function cloneASTElement(el) {
  return Object(lone_compiler_core_parser_index__WEBPACK_IMPORTED_MODULE_1__["createASTElement"])(el.tag, el.attrsList.slice(), el.parent);
}
...
/* harmony import */ var lone_util_web_style__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lone-util/web/style */ "./packages/lone-util/web/style.js");
/* harmony import */ var lone_compiler_core_helpers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lone-compiler-core/helpers */ "./packages/lone-compiler-core/helpers.js");
/* @flow */
...
function transformNode(el, options) {
  ...
  if (staticStyle) {
    /* istanbul ignore if */
    if (true) {
      const expression = Object(lone_compiler_core_parser_text_parser__WEBPACK_IMPORTED_MODULE_0__["parseText"])(staticStyle, options.delimiters);
...
/* harmony import */ var lone_util_web__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lone-util/web */ "./packages/lone-util/web/index.js");
/* harmony import */ var _modules_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/index */ "./packages/lone-compiler-dom/modules/index.js");
/* harmony import */ var _directives_index__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./directives/index */ "./packages/lone-compiler-dom/directives/index.js");
...
const baseOptions = {
  ...
  isPreTag: lone_util_web__WEBPACK_IMPORTED_MODULE_0__["isPreTag"],
  isUnaryTag: lone_util__WEBPACK_IMPORTED_MODULE_3__["isUnaryTag"],
  mustUseProp: lone_util_web__WEBPACK_IMPORTED_MODULE_0__["mustUseProp"],
  canBeLeftOpenTag: lone_util__WEBPACK_IMPORTED_MODULE_3__["canBeLeftOpenTag"],
  isReservedTag: lone_util_web__WEBPACK_IMPORTED_MODULE_0__["isReservedTag"],
  getTagNamespace: lone_util_web__WEBPACK_IMPORTED_MODULE_0__["getTagNamespace"],
  staticKeys: Object(lone_util__WEBPACK_IMPORTED_MODULE_3__["genStaticKeys"])(_modules_index__WEBPACK_IMPORTED_MODULE_1__["default"])
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var lone_virtualdom_render_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lone-virtualdom/render-helpers */ "./packages/lone-virtualdom/render-helpers.js");
...
function initRender(vm) {
  const {
    render
  } = Object(lone_compiler_dom__WEBPACK_IMPORTED_MODULE_1__["compileToFunctions"])(vm.template, undefined, vm);
...
/*!***********************************!*\
  !*** ./packages/lone-util/env.js ***!
  \***********************************/
/*! exports provided: inBrowser, UA, isIE, isIE9, isEdge, isAndroid, isIOS, isChrome */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!*****************************************!*\
  !*** ./packages/lone-util/web/attrs.js ***!
  \*****************************************/
/*! exports provided: isReservedAttr, mustUseProp, isEnumeratedAttr, isBooleanAttr, xlinkNS, isXlink, getXlinkProp, isFalsyAttrValue */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../index */ "./packages/lone-util/index.js");
/* @flow */
 // these are reserved for web because they are directly compiled away
// during template compilation

const isReservedAttr = Object(_index__WEBPACK_IMPORTED_MODULE_0__["makeMap"])('style,class'); // attributes that should be using props for binding

const acceptValue = Object(_index__WEBPACK_IMPORTED_MODULE_0__["makeMap"])('input,textarea,option,select,progress');
...
const isEnumeratedAttr = Object(_index__WEBPACK_IMPORTED_MODULE_0__["makeMap"])('contenteditable,draggable,spellcheck');
const isBooleanAttr = Object(_index__WEBPACK_IMPORTED_MODULE_0__["makeMap"])('allowfullscreen,async,autofocus,autoplay,checked,compact,controls,declare,' + 'default,defaultchecked,defaultmuted,defaultselected,defer,disabled,' + 'enabled,formnovalidate,hidden,indeterminate,inert,ismap,itemscope,loop,multiple,' + 'muted,nohref,noresize,noshade,novalidate,nowrap,open,pauseonexit,readonly,' + 'required,reversed,scoped,seamless,selected,sortable,translate,' + 'truespeed,typemustmatch,visible');
...
/*!*****************************************!*\
  !*** ./packages/lone-util/web/class.js ***!
  \*****************************************/
/*! exports provided: genClassForVnode, renderClass, concat, stringifyClass */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function genClassForVnode(vnode) {
  ...
  while (Object(_index__WEBPACK_IMPORTED_MODULE_0__["isDef"])(childNode.componentInstance)) {
  ...
  while (Object(_index__WEBPACK_IMPORTED_MODULE_0__["isDef"])(parentNode = parentNode.parent)) {
    if (parentNode.data) {
...
function mergeClassData(child, parent) {
  return {
    ...
    class: Object(_index__WEBPACK_IMPORTED_MODULE_0__["isDef"])(child.class) ? [child.class, parent.class] : parent.class
  };
}

function renderClass(staticClass, dynamicClass) {
  if (Object(_index__WEBPACK_IMPORTED_MODULE_0__["isDef"])(staticClass) || Object(_index__WEBPACK_IMPORTED_MODULE_0__["isDef"])(dynamicClass)) {
...
function stringifyClass(value) {
  ...
  if (Object(_index__WEBPACK_IMPORTED_MODULE_0__["isObject"])(value)) {
...
function stringifyArray(value) {
  ...
  for (let i = 0, l = value.length; i < l; i++) {
    if (Object(_index__WEBPACK_IMPORTED_MODULE_0__["isDef"])(stringified = stringifyClass(value[i])) && stringified !== '') {
      if (res) res += ' ';
      res += stringified;
    }
  }
...
/*!*******************************************!*\
  !*** ./packages/lone-util/web/element.js ***!
  \*******************************************/
/*! exports provided: namespaceMap, isHTMLTag, isSVG, isPreTag, isReservedTag, getTagNamespace, isUnknownElement, isTextInputType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _env__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../env */ "./packages/lone-util/env.js");
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../index */ "./packages/lone-util/index.js");
/* @flow */
...
const isHTMLTag = Object(_index__WEBPACK_IMPORTED_MODULE_1__["makeMap"])('html,body,base,head,link,meta,style,title,' + 'address,article,aside,footer,header,h1,h2,h3,h4,h5,h6,hgroup,nav,section,' + 'div,dd,dl,dt,figcaption,figure,picture,hr,img,li,main,ol,p,pre,ul,' + 'a,b,abbr,bdi,bdo,br,cite,code,data,dfn,em,i,kbd,mark,q,rp,rt,rtc,ruby,' + 's,samp,small,span,strong,sub,sup,time,u,var,wbr,area,audio,map,track,video,' + 'embed,object,param,source,canvas,script,noscript,del,ins,' + 'caption,col,colgroup,table,thead,tbody,td,th,tr,' + 'button,datalist,fieldset,form,input,label,legend,meter,optgroup,option,' + 'output,progress,select,textarea,' + 'details,dialog,menu,menuitem,summary,' + 'content,element,shadow,template,blockquote,iframe,tfoot'); // this map is intentionally selective, only covering SVG elements that may
// contain child elements.

const isSVG = Object(_index__WEBPACK_IMPORTED_MODULE_1__["makeMap"])('svg,animate,circle,clippath,cursor,defs,desc,ellipse,filter,font-face,' + 'foreignObject,g,glyph,image,line,marker,mask,missing-glyph,path,pattern,' + 'polygon,polyline,rect,switch,symbol,text,textpath,tspan,use,view', true);
...
function isUnknownElement(tag) {
  /* istanbul ignore if */
  if (!_env__WEBPACK_IMPORTED_MODULE_0__["inBrowser"]) {
    return true;
  }
...
const isTextInputType = Object(_index__WEBPACK_IMPORTED_MODULE_1__["makeMap"])('text,number,password,search,email,tel,url');
...
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../index */ "./packages/lone-util/index.js");
/* harmony import */ var _attrs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./attrs */ "./packages/lone-util/web/attrs.js");
...
/* harmony import */ var _class__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./class */ "./packages/lone-util/web/class.js");
...
/* harmony import */ var _element__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./element */ "./packages/lone-util/web/element.js");
...
function query(el) {
  if (typeof el === 'string') {
    ...
    if (!selected) {
       true && Object(_index__WEBPACK_IMPORTED_MODULE_0__["warn"])('Cannot find element: ' + el);
...
/*!*****************************************!*\
  !*** ./packages/lone-util/web/style.js ***!
  \*****************************************/
/*! exports provided: parseStyleText, normalizeStyleBinding, getStyle */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const parseStyleText = Object(_index__WEBPACK_IMPORTED_MODULE_0__["cached"])(function (cssText) {
  const res = {};
...
function normalizeStyleData(data) {
  ...
  return data.staticStyle ? Object(_index__WEBPACK_IMPORTED_MODULE_0__["extend"])(data.staticStyle, style) : style;
} // normalize possible array / string values into Object


function normalizeStyleBinding(bindingStyle) {
  if (Array.isArray(bindingStyle)) {
    return Object(_index__WEBPACK_IMPORTED_MODULE_0__["toObject"])(bindingStyle);
  }
  ...
  if (checkChild) {
    ...
    while (childNode.componentInstance) {
      ...
      if (childNode.data && (styleData = normalizeStyleData(childNode.data))) {
        Object(_index__WEBPACK_IMPORTED_MODULE_0__["extend"])(res, styleData);
      }
    }
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var lone_util_web__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lone-util/web */ "./packages/lone-util/web/index.js");
/* harmony import */ var lone_page_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lone-page/component */ "./packages/lone-page/component/index.js");
...
/* harmony import */ var _create_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./create-component */ "./packages/lone-virtualdom/create-component.js");
/* harmony import */ var snabbdom_h__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! snabbdom/h */ "./packages/lone-virtualdom/node_modules/snabbdom/h.js");
/* harmony import */ var snabbdom_h__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(snabbdom_h__WEBPACK_IMPORTED_MODULE_7__);
/* harmony reexport (default from non-harmony) */ __webpack_require__.d(__webpack_exports__, "h", function() { return snabbdom_h__WEBPACK_IMPORTED_MODULE_7___default.a; });
...
/* harmony import */ var _vnode__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./vnode */ "./packages/lone-virtualdom/node_modules/snabbdom/es/vnode.js");
/* harmony import */ var _is__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./is */ "./packages/lone-virtualdom/node_modules/snabbdom/es/is.js");
...
/***/ "./packages/lone-virtualdom/node_modules/snabbdom/es/htmldomapi.js":
/*!*************************************************************************!*\
  !*** ./packages/lone-virtualdom/node_modules/snabbdom/es/htmldomapi.js ***!
  \*************************************************************************/
...
/***/ "./packages/lone-virtualdom/node_modules/snabbdom/es/is.js":
/*!*****************************************************************!*\
  !*** ./packages/lone-virtualdom/node_modules/snabbdom/es/is.js ***!
  \*****************************************************************/
...
/***/ "./packages/lone-virtualdom/node_modules/snabbdom/es/snabbdom.js":
/*!***********************************************************************!*\
  !*** ./packages/lone-virtualdom/node_modules/snabbdom/es/snabbdom.js ***!
  \***********************************************************************/
...
/* harmony import */ var _vnode__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./vnode */ "./packages/lone-virtualdom/node_modules/snabbdom/es/vnode.js");
/* harmony import */ var _is__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./is */ "./packages/lone-virtualdom/node_modules/snabbdom/es/is.js");
/* harmony import */ var _htmldomapi__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./htmldomapi */ "./packages/lone-virtualdom/node_modules/snabbdom/es/htmldomapi.js");
/* harmony import */ var _h__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./h */ "./packages/lone-virtualdom/node_modules/snabbdom/es/h.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "h", function() { return _h__WEBPACK_IMPORTED_MODULE_3__["h"]; });

/* harmony import */ var _thunk__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./thunk */ "./packages/lone-virtualdom/node_modules/snabbdom/es/thunk.js");
...
/***/ "./packages/lone-virtualdom/node_modules/snabbdom/es/thunk.js":
/*!********************************************************************!*\
  !*** ./packages/lone-virtualdom/node_modules/snabbdom/es/thunk.js ***!
  \********************************************************************/
...
/* harmony import */ var _h__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./h */ "./packages/lone-virtualdom/node_modules/snabbdom/es/h.js");
...
/***/ "./packages/lone-virtualdom/node_modules/snabbdom/es/vnode.js":
/*!********************************************************************!*\
  !*** ./packages/lone-virtualdom/node_modules/snabbdom/es/vnode.js ***!
  \********************************************************************/
...
/***/ "./packages/lone-virtualdom/node_modules/snabbdom/h.js":
/*!*************************************************************!*\
  !*** ./packages/lone-virtualdom/node_modules/snabbdom/h.js ***!
  \*************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var vnode_1 = __webpack_require__(/*! ./vnode */ "./packages/lone-virtualdom/node_modules/snabbdom/vnode.js");
var is = __webpack_require__(/*! ./is */ "./packages/lone-virtualdom/node_modules/snabbdom/is.js");
function addNS(data, children, sel) {
    data.ns = 'http://www.w3.org/2000/svg';
    if (sel !== 'foreignObject' && children !== undefined) {
        for (var i = 0; i < children.length; ++i) {
...
/***/ "./packages/lone-virtualdom/node_modules/snabbdom/is.js":
/*!**************************************************************!*\
  !*** ./packages/lone-virtualdom/node_modules/snabbdom/is.js ***!
  \**************************************************************/
/*! no static exports found */
...
/***/ "./packages/lone-virtualdom/node_modules/snabbdom/modules/class.js":
/*!*************************************************************************!*\
  !*** ./packages/lone-virtualdom/node_modules/snabbdom/modules/class.js ***!
  \*************************************************************************/
/*! no static exports found */
...
/***/ "./packages/lone-virtualdom/node_modules/snabbdom/modules/eventlisteners.js":
/*!**********************************************************************************!*\
  !*** ./packages/lone-virtualdom/node_modules/snabbdom/modules/eventlisteners.js ***!
  \**********************************************************************************/
/*! no static exports found */
...
/***/ "./packages/lone-virtualdom/node_modules/snabbdom/modules/props.js":
/*!*************************************************************************!*\
  !*** ./packages/lone-virtualdom/node_modules/snabbdom/modules/props.js ***!
  \*************************************************************************/
/*! no static exports found */
...
/***/ "./packages/lone-virtualdom/node_modules/snabbdom/modules/style.js":
/*!*************************************************************************!*\
  !*** ./packages/lone-virtualdom/node_modules/snabbdom/modules/style.js ***!
  \*************************************************************************/
/*! no static exports found */
...
/***/ "./packages/lone-virtualdom/node_modules/snabbdom/vnode.js":
/*!*****************************************************************!*\
  !*** ./packages/lone-virtualdom/node_modules/snabbdom/vnode.js ***!
  \*****************************************************************/
/*! no static exports found */
...
/***/ "./packages/lone-virtualdom/render-helpers.js":
/*!****************************************************!*\
  !*** ./packages/lone-virtualdom/render-helpers.js ***!
  \****************************************************/
...
function installRenderHelpers(target) {
  const proto = target.prototype; // createTextVNode

  proto._v = text => text; // create Element Vnode


  proto._c = _index__WEBPACK_IMPORTED_MODULE_1__["h"];
  proto._s = lone_util__WEBPACK_IMPORTED_MODULE_0__["toString"];
  proto._l = _render_list__WEBPACK_IMPORTED_MODULE_2__["renderList"];
  proto._i = lone_util__WEBPACK_IMPORTED_MODULE_0__["looseIndexOf"];
  proto._q = lone_util__WEBPACK_IMPORTED_MODULE_0__["looseEqual"]; // target._o = markOnce
